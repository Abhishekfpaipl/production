<template>
    <div style="height: 100vh">
            <div class="pt-0 px-0" style="background-color: #e8e8e8; padding-bottom: 20px;">
                <div class="container p-2 border-bottom bg-white" >
                    <div class="d-flex justify-content-between">
                       <div class="d-flex">
                        <img :src="`${publicPath}${finishing.img}`" class="rounded-circle"
                        ...
                        <div class="d-flex flex-column ms-2" data-bs-toggle="collapse" data-bs-target="#collapseExample">
                            <b class="m-0">#{{ finishing.style }} | <span>Bal : {{ finishing.bal }}
                                </span>
                            </b>
                            <p class="m-0 text-success">{{ finishing.date }} | <span>{{ finishing.time }}
                                </span>
                            </p>
                        </div>
                       </div>
                ...
                <div class="collapse" id="collapseExample">
                    <img :src="`${publicPath}${finishing.img}`" style=" width: 100%;  object-fit: fill;">
                    <div class="box mt-2">
                        <table class="table table-striped table-hover">
                            <tbody>
                                <tr>
                                    <th scope="row">Name</th>
                                    <td class="text-muted">{{ finishing.name }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Sale Price</th>
                                    <td class="text-muted">{{ finishing.sp }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Panna</th>
                                    <td class="text-muted">{{ finishing.panna }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Fc / Piece</th>
                                    <td class="text-muted">{{ finishing.fc }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Search Tags</th>
                                    <td class="text-muted">{{ finishing.stag }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<script>
    ...
    computed: {
        ...
        finishing() {
            let finishingId = this.$route.params.finishingId;
            return this.$store.getters.getFinishing(finishingId);
        },
    },
    methods:{
        balanceQuantity() {
